...
public class AITest {
    ...
    @Test
    void f() {
        String str = "在韩国政坛，一场前所未有的政治风暴正在酝酿。总统尹锡悦宣布紧急戒严后，一系列令人震惊的事件接踵而至，引发了国内外的广泛关注。据透露，尹锡悦在宣布戒严时，曾亲自指示国防部国防防谍司令吕寅兄合作，准备逮捕包括共同民主党党首李在明在内的多名国会议员。这一消息如同一枚重磅炸弹，瞬间引爆了韩国政坛。然而，就在舆论一片哗然之际，韩国总统府却出面否认了这一说法，称尹锡悦并未下令抓捕政治人物。但随后，总统府又撤回了相关表态，使得整个事件更加扑朔迷离。关于尹锡悦是否曾下令抓人，目前韩国政坛各方说法不一，外界分析认为，这或将影响执政党关于弹劾投票的倾向，进而左右弹劾案是否通过韩国国会。与此同时，以共同民主党为首的在野阵营迅速启动了弹劾总统程序，6个在野党联手提出对韩国总统尹锡悦的弹劾动议案。而执政的国民力量党则召开了全体议员大会，确定了反对弹劾总统的方针。但令人意想不到的是，国民力量党党首韩东勋突然转变态度，要求尹锡悦尽快停止履行总统职务。这意味着执政党内出现了支持弹劾总统的声音，弹劾动议案通过的可能性大增。国会定于12月7日进行弹劾动议案投票表决。如果表决通过，尹锡悦将被停止行使总统权力，等待宪法法院裁决；即使表决未通过，他也将面对“发动内乱”的司法指控。在野党誓言要将尹锡悦拉下马，而尹锡悦则面临着众叛亲离、孤立无援的境地。这场政治风暴不仅搅乱了韩国政坛，也对韩国的经济和对外形象造成了严重影响。多个国家发出赴韩旅游警报，多个国际会议和访问行程被推迟或取消。如果失去美国的支持，尹锡悦的执政根基将更加动摇。随着宪政危机的扩散，韩国的动荡局势还会持续下去。在这个关键时刻，韩国的命运如同“风中烛火”，随时可能崩溃。无论弹劾案最终结果如何，尹锡悦都注定会以不受欢迎的总统形象停留在韩国人的记忆中。";
        String[] strings = str.trim().split("。");
        int firstIndex = RandomUtil.randomInt(0, strings.length);
        int lastIndex = RandomUtil.randomInt(firstIndex, strings.length);
        System.out.printf("第一个下标:%s,第二个下标:%s%n",firstIndex,lastIndex);
    }
